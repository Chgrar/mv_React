export const Data = {
    ...
    {
        id:1,
        nombre:"Remera Slimfit con el escote en V, Blanca",
    ...
    {
        id:2,
        nombre:"Remera Slimfit con el escote en V, Negra",
        descripcion:"Terminaciones finas, hechas de algodon de primera calidad, para acompañarte en tus entrenamientos o salidas",
    ...
    {
        id:3,
        nombre:"Remera slimfit rústica de cuello amplio, Blanca",
    ...
    {
        id:4,
        nombre:"Remera slimfit rústica de cuello amplio, Negra",
        descripcion:"Tela de algodón transpirable, super livianas y frescas para usar en cualquier ocasión",
    ...
    {
        id:5,
        nombre:"Musculosa You vs You urbana, Negra",
    ...
    {
        id:6,
        nombre:"Musculosa You vs You urbana, Azul",
        descripcion:"Tela 100% algodón transpirable que deja respirar la piel y absorbe la humedad del sudor. Frescas, livianas y con todo el estilo",
    ...
    {
        id:7,
        nombre:"Musculosa Box con capucha",
    ...
    {
        id:8,
        nombre:"Short MV Bicolor, deportivo de algodón",
    ...
    {
        id:9,
        nombre:"Conjunto deportivo Gymsis II, Negro",
    ...
    {
        id:10,
        nombre:"Conjunto deportivo Gymsis, Azul",
    ...
    {
        id:11,
        nombre:"Conjunto deportivo Gymsis, Negro",
        descripcion:" Calzas cortas Tiro medio  //  Top corto espalda abierta",
    ...
    {
        id:12,
        nombre:"Conjunto deportivo Gymsis II, Azul",
    ...
    {
        id:13,
        nombre:"Musculosa rústica, Negra",
    ...
    {
        id:14,
        nombre:"Musculosa rústica, Blanca",
        descripcion:"100% algodón transpirable de primera calidad, cómodas y frescas para entrenar al máximo nivel",
    ...
    {
        id:15,
        nombre:"Remeron oversize Minimal",
    ...
    {
        id:16,
        nombre:"Musculosa minimal urbana, Negra",
        descripcion:"Tela 100% algodón transpirable que deja respirar la piel y absorbe la humedad del sudor. Suaves y super cómodas para entrenar",
    ...
    {
        id:17,
        nombre:"Musculosa minimal urbana, Roja",
        descripcion:"Tela 100% algodón transpirable que deja respirar la piel y absorbe la humedad del sudor. Suaves y super cómodas para entrenar",
    ...
    {
        id:18,
        nombre:"Remeron VALHALLA oversize, Negro",
    ...
    {
        id:19,
        nombre:"Remeron VALHALLA oversize, Rojo",
        descripcion:"100% algodón transpirable de primera calidad, ideales para entrenar y para salir",
